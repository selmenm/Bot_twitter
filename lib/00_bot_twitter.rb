...
client = login_twitter
 ...
 client.update('Mon quatrième tweet en Ruby !!!!')
end 

def hello_journalists
# Dis bonjour_monde à 5journalistes
client = login_twitter
5.times do 
    client.update("#{@ary.sample} Mon chat bot vous souhaite le bonjour!! Signé un jeune codeur #bonjour_monde")
end
end

def lookforhash
#Recherche des tweetos avec le #bonjour et les like
    client = login_twitter
